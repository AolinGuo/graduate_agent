...
2. **法律合规性 (Legal Compliance)**: 必须严格引用【提供的法律依据】。严禁编造法律名称。
...
"""
        ...
        messages = [
            {
                "role": "system",
                "content": "你是一个极其苛刻的法律文本审查员，专门对比 AI 生成内容与标准答案之间的细微差别。",
            },
    ...
    def print_summary(self, all_results: List[Dict], model_keys: List[str]):
        ...
        print("=" * 70)
        print(
            f"详细报告已保存至: {EXTERNAL_EVAL_DIR / 'comparison_api_evaluation.json'}"
        )
